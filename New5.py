...
cl = LINETCR.LINE()
cl.login(token="EqQftqwPVZGxDDsXv7S5.FsWACvo8kRbxJig+CjYizq.TcSl67S1jUdK477DURBqQOY3Ia5ppGgxSHzj5SQR+U0=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EqXsBheCWY02KC06UtU5.m24QFil2PVqwRWxTRcDmTq.5shXs6xcLkhlNoM0mfJLIMHjO1wckj4tsalx89mRmpI=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqkQFrYOqIZEP16CUJBb.RSh+iK1ZInfmVNTOh0VH2W.15UUBHODqaOQiOPL4bRoslgHzKtPvq1uLSJFI+eOsnU=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Eqq6yvvgvRLFuc9TQzRf.KOqs2yFdapOk6Y4NLqszxW.8E+AOCgmN5FVBUDe4hCAjfPqXhiu7qZ0J6h0Uk0xmOA=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqYE3jUCshctA7WKaar4.Uu4euteNTvpsKrni11YDPa.bxBe76v7H8VJIvGv2soDwU8cq+tqlNrISMbI3kpu9s0=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Eq4Stfg9BdgSNJjP3LCa.a4sLI9QYZ/qD6EtGhlmvgG.RjFoec/PcdIodgPvIpl/7DQQP04nKViosOROC2iPR1w=")
ki5.loginResult()
...
❂͜͡☆➣ 『tag1』ข้อความแทค1
❂͜͡☆➣ 『tag2』ข้อความแทค2
❂͜͡☆➣ 『Hhx1』ข้อความต้อนรับ
❂͜͡☆➣ 『Hhx2』ข้อความคนออก
❂͜͡☆➣ 『Hhx3』ข้อความคนลบ
❂͜͡☆➣ 『PK@』เตะสมาชิก
❂͜͡☆➣ 『PK2@』คิกเตะ
❂͜͡☆➣ 『ลบรัน』
...
╠══════════════════════
║✰ Add on ➠เปิดข้อความเพิ่มเพื่อน
║✰ Add off ➠เปิดข้อความเพิ่มเพื่อน
...
╠══════════════════════
║✰ Tag1 ➠เช็คข้อความแทค1
║✰ Tag2 ➠เช็คข้อความแทค2
║✰ Com ➠เช็คข้อความเพิ่มเพื่อน
...
targets = []
mid = cl.getProfile().mid
Bots = ["u7d2c1a7153bc2ab0578c81bf709c8865",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
self = ["u7d2c1a7153bc2ab0578c81bf709c8865",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
admin = "u7d2c1a7153bc2ab0578c81bf709c8865"
admsa = "u7d2c1a7153bc2ab0578c81bf709c8865"
owner = "u7d2c1a7153bc2ab0578c81bf709c8865"
adminMID = "u7d2c1a7153bc2ab0578c81bf709c8865"
Creator="u7d2c1a7153bc2ab0578c81bf709c8865"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks for add Me MY NAME IS MIN",
    "lang":"JP",
    "comment1":"""
           SELF BOT BY MIN
             AUTO LIKE ON
...
#-------------------------------------------------
                        ...
                        cl.sendText(msg.to,"─┅══ईह ㏒ มิน ㏒ ईह══┅─\n\n[SELF BOT Min HACK BOT]")
                        cl.sendText(msg.to,"Please wait......")
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like By. มิน ทีมทดลองบอท")
        ...
        if op.type == 26:
            ...
            elif msg.text in ["มิน","พี่มิน","มินครับ"]:
                        cl.sendText(msg.to,"มินไม่ว่างคุยกับน้องตูนอยู่...")
            elif msg.text in ["อยู่ไหม",".อยู่ไหม","อยู่มั้ย"]:
